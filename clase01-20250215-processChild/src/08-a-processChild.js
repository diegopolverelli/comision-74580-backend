...
app.get('/calculo2', (req, res) => {
    ...
    procesoHijo.send(`Soy el proceso principal, con pid ${process.pid}, y necesito que te ejecutes...!!!`)
    procesoHijo.on("message", msg=>{
...
const server = app.listen(PORT, () => {
    console.log(`Server escuchando en puerto ${PORT} - Proceso SO: ${process.pid}`);
});
