import { BadRequestException, Body, Controller, Get, Logger, Param, ParseIntPipe, Post, Query, ValidationPipe } from '@nestjs/common';
...
class AddUser{
  ...
  @IsString({message:"Apellido es requerido y debe ser de tipo cadena de caracteres"})
  apellido:string
...
export class AppController {
  ...
  @Post("usuarios")
  agregarUsuario(@Body(new ValidationPipe({whitelist:true, forbidNonWhitelisted:true})) datos:AddUser){
    console.log(datos)
    // datos.estatura=1.7
