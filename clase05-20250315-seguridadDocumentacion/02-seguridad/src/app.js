...
app.post('/mail', upload.array("adjuntos"), async (req, res) => {
    ...
    let resultado 
    try {
        resultado = await enviar(to, subject, message, req.files)
    } catch (error) {
        res.setHeader('Content-Type','application/json');
...
await mongoose.connect('mongodb+srv://coderhouse:codercoder2023@cluster0.wpxpupc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&dbName=comis74580clase05')
